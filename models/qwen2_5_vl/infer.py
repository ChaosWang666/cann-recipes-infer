...
from runner_qwen2_5_vl import Qwen2_5_VLRunner
...
def parse_args():
    parser = argparse.ArgumentParser(description="qwen2.5-vl run parameters")
...
if __name__ == "__main__":
    ...
    run_qwen2_5_vl(runner_settings)
